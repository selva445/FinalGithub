    ...
    public class SearchClaim {
        ...
        public  static void Execute(int iTestCaseRow,String TC_Name) throws Exception{
					...
					if (Valpos > 0)
					{
						...
						if (Class_Name.equalsIgnoreCase(class_name))
						{
							...
							case "EditConstant":
								...
								Reusable.Enter_Value_WebElementConstant(driver,iTestCaseRow,obj, Class_Name,TC_Name);								
								  
								break;
							case "EditClear":
								
								Reusable.Clear_Value_WebElement(driver,iTestCaseRow,obj, Class_Name,TC_Name);								
        	...
        	catch(Exception e)
        	{
        		...
        		System.out.println("Error in SearchClaim :"+e.toString());
        		Extend_Report.AddReport("Error in SearchClaim Page ", "Fail");
