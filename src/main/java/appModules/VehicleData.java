    ...
    public class VehicleData {
        ...
        public  static void Execute(int iTestCaseRow,String TC_Name) throws Exception{
					...
					if (Valpos > 0)
					{
						...
						if (Class_Name.equalsIgnoreCase(class_name))
						{
							...
							case "FrameChange":
								...
								break;
							case "ClickElementRandom":
								
								Reusable.MouseOver_WebElementClickRandom(driver,iTestCaseRow,obj, Class_Name,TC_Name);
							...
							case "Sikulitest":
								...
								Reusable.SikuliClick(driver,iTestCaseRow,obj, Class_Name,TC_Name);
        	...
        	catch(Exception e)
        	{
        		...
        		System.out.println("Error in VehicleData :"+e.toString());
        		Extend_Report.AddReport("Error in VehicleData Page ", "Fail");
