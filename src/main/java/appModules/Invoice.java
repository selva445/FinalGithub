    ...
    public class Invoice {
        ...
        public  static void Execute(int iTestCaseRow,String TC_Name) throws Exception{
					...
					if (Valpos > 0)
					{
						...
						if (Class_Name.equalsIgnoreCase(class_name))
						{
							...
							case "Edit":
								...
								Reusable.Enter_Value_WebElement_Set(driver,iTestCaseRow,obj, Class_Name,TC_Name);								
							...
							case "TypeListValue":
								...
								break;
							case "ExportExcel":
								Reusable.ExportExcel(driver,iTestCaseRow, obj, Class_Name,TC_Name);
        	...
        	catch(Exception e)
        	{
        		...
        		System.out.println("Error in Invoice :"+e.toString());
        		Extend_Report.AddReport("Error in Invoice Page ", "Fail");
